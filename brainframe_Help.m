...
input_struct.conmat = input_struct.conmat - ...
    diag(diag(input_struct.conmat)); %zeroing out the diagonal
input_struct.conmat(input_struct.conmat<prctile(input_struct.conmat(:),99)) = 0; %setting threshold for visualization
...
input_struct.xfac = 1; %Remember sphere rescaling very different
